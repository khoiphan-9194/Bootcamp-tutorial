...
* As a developer, I want to be able to reuse my `findAverage` function in multiple reduce method calls throughout my application so that my code is not being duplicated unnecessarily.
